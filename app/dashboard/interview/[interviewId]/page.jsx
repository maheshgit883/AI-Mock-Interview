...
function Interview({ params }) {
  ...
  useEffect(() => {
    // Check if the webcam state is stored in sessionStorage
    const storedWebcamState = sessionStorage.getItem("webCamEnabled");
    if (storedWebcamState === "true") {
  ...
  const handleWebcamToggle = () => {
    if (!webCamEnabled) {
      navigator.mediaDevices.getUserMedia({ video: true })
        .then(() => {
          setWebCamEnabled(true);
          sessionStorage.setItem("webCamEnabled", "true"); // Save state in sessionStorage
      ...
      sessionStorage.removeItem("webCamEnabled"); // Remove state from sessionStorage
    }
  };
